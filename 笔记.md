...
![image-20201009201533890](笔记/image-20201009201533890.png)



## 学习ElementUI

第一章的代码用网络引用的方式，而不用本地的方式，这样不用在本地导入，但也有比较慢的缺点

学习了八个 demo ， 这些 demo 可随意移动，而且相互无依赖

![image-20201009202912794](笔记/image-20201009202912794.png)
...
![image-20201009210827093](笔记/image-20201009210827093.png)

## 导入项目所需公共资源

### 工具类

返回消息常量类MessageConstant、返回结果Result和PageResult类、封装查询条件的QueryPageBean类

![image-20201009212921095](笔记/image-20201009212921095.png)

### 静态资源

![image-20201009213405014](笔记/image-20201009213405014.png)
